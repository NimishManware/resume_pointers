...
void ReaderLock(struct read_write_lock * rw)
{
  ...
  // cout<<"readLock, numRead is "<<rw->numRead<<endl;
  rw->numRead++;
  // cout<<"readLock over, numRead is "<<rw->numRead<<endl;
...
void ReaderUnlock(struct read_write_lock * rw)
{
  ...
  pthread_mutex_lock(&rw->thing);
  // cout<<"read unlock, numRead is "<<rw->numRead<<endl;
  rw->numRead--;
  // cout<<"read unlock over, numRead is "<<rw->numRead<<endl;
  pthread_mutex_unlock(&rw->thing);
}
...
void WriterUnlock(struct read_write_lock * rw)
{
  ...
  rw->numWrit--;
  pthread_mutex_unlock(&rw->thing);
  // cout<<"write unlock over, numRead is "<<rw->numRead<<endl;
}
