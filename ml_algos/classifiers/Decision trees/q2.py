...
class SKLearnDecisionTree:
    ...
    def train_model(self, criterion="entropy",random_state = 42):
        ...
        results = {}
        self.tree = DecisionTreeClassifier(random_state=random_state,criterion=criterion)
    ...
    def train_model_regularised(self, criterion="entropy",random_state = 42):
        ...
        for max_depth in range(1,11):
            for min_samples_split in range(3,31,3):
                for min_samples_leaf in range(1,11):
                    self.tree = DecisionTreeClassifier(random_state=random_state,criterion=criterion,min_samples_leaf=min_samples_leaf,
                                                max_depth=max_depth,min_samples_split = min_samples_split)
                    self.tree.fit(self.X_train,self.Y_train)
                    results["train_accuracies"].append(metrics.accuracy_score(self.Y_train,self.tree.predict(self.X_train)))
                    results["test_accuracies"].append(metrics.accuracy_score(self.Y_test,self.tree.predict(self.X_test)))
